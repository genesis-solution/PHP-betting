...
$(document).ready(function () {  
  ...
  const receipt = (ticketInfo) => {
	// window.open(`https://kiosk.swer3.live/templates/ticket.php?ticket_number=${ticketInfo[ticketInfo.length-1].ticket_number}`);
    window.open(`http://192.168.108.79/templates/ticket.php?ticket_number=${ticketInfo[ticketInfo.length-1].ticket_number}`);
  }
