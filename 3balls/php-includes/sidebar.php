                ...
                <div class="profile-info">
                    <div class="user-info">
                        <div class="profile-content" style="width: 100%;text-align:center;">
                            <img src="src/assets/img/pick3-logo.png" style="height:90px;">
                        </div>
                    </div>
                </div>
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu active">
					 ...
					 <li class="menu menu-heading">
                        <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>Wallet</span></div>
                    </li>
					<li class="menu">
