...
<head>
    ...
    <link rel="stylesheet" href="src/assets/css/dashboardvv.style.css">
    <style>
...
<body class="layout-boxed">
                        ...
                        <div class="col-12 col-xl-12">
                            ...
                            <button type="button" class="form-control mt-3 stream_btn" id="stream_btn"> Stream </button>
                             ...
                             <div class="d-flex justify-content-between">
                                <div class="d-flex justify-content-start align-items-center gap-1 mt-4 mb-1">
                                ...
                                <div class="d-flex justify-content-end align-items-center gap-1 mt-4 mb-1">
                                    <img src="src/assets/img/money-icon.png" class="money-icon mb-1 mb-sm-2" alt="money-icon" height="30" width="30">
                                    <h5 class="my-0 balance" style="color:#e2a03f;" >
                                        <div> 
                                        Revolving: <span id="starting_balance"> Loading... </span>
                                    </h5>                               
                                </div>
                            </div>
							...
							<?php include('php-includes/betting-area-modal.php');?>
							<?php include('php-includes/betting-list-modal.php');?>
    ...
    <script src="php-includes/js/pick3-programcsqs.js"></script>
    <script src="php-includes/js/transactionHistoraa.js"></script>
    <script src="php-includes/js/gameHistoryys.js"></script>
